...
- (CABasicAnimation *)opacityAnimationWithTimingFunction:(CAMediaTimingFunction *)timingFunction{
...
- (void)mdAnimateAtPoint:(CGPoint)point backgroundColor:(UIColor *)backgroundColor duration:(NSTimeInterval)duration inflating:(BOOL)inflating zTopPosition:(BOOL)zTopPosition shapeLayer:(CAShapeLayer *)shapeLayer completion:(void (^)(void))block {
    ...
    CABasicAnimation *opacityAnimation = [self opacityAnimationWithTimingFunction:[CAMediaTimingFunction functionWithName:timingFunctionName]];
    ...
    groupAnnimation.duration = duration;
    groupAnnimation.animations = @[animation, opacityAnimation];
    
    [shapeLayer addAnimation:groupAnnimation forKey:@"shapeBackgroundAnimation"];
